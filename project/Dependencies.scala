...
object Dependencies {
  ...
  object slf4j {
    val api: ModuleID        = "org.slf4j" % "slf4j-api"    % "2.0.6"
  ...
  object software {
    ...
    object awssdk {
      val s3 = "software.amazon.awssdk" % "s3" % "2.17.295"
    }
  ...
  object scala {
    val collectionCompat: ModuleID         = "org.scala-lang.modules" %% "scala-collection-compat" % "2.9.0"
    def reflect(version: String): ModuleID = "org.scala-lang"          % "scala-reflect"           % version
  }

  object logback {
    val classic: ModuleID = "ch.qos.logback" % "logback-classic" % "1.4.6"
  }
